---
title: "Textual - Border-title-style"
source: "https://textual.textualize.io/styles/border_title_style/"
author:
...
The `border-title-style` style sets the text style of the [border\_title](https://textual.textualize.io/api/widget/#textual.widget.Widget.border_title " border_title").
