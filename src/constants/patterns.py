...
PATTERNS = {
    ...
    "WINDOW": {"DEFAULT": ["╔{fill}╗", "│{content}│", "╚{fill}╝"], "ACTIVE": ["╔{fill}╗", "║{content}║", "╚{fill}╝"]},
    "TEXT_INPUT": {"DEFAULT": ["~{label}:\\> {text}"], "FOCUSED": ["~{label}:\\> {text}█"]},
    "BUTTON": {
        "DEFAULT": ["[{text}]"],
        "ACTIVE": ["[{text}]"],
        "INACTIVE": ["[{text}]"],
    ...
    "PALETTE_MANAGEMENT": {
        "HEADER": (
            "╠───────────────╦      ┌█───█┐ ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐ ┌─────┐  │\n"
            "│ > Color Tools │      │{empty:5}│ │{empty:5}│ "
            "│{empty:5}│ │{empty:5}│ │{empty:5}│ │{empty:5}│ │{empty:5}│ │{empty:5}│  │\n"
            "╠───────────────╝      └─────┘ └─────┘ └─────┘ └─────┘ └─────┘ └─────┘ └─────┘ └─────┘  │"
        ),
